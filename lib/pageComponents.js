...
const PageComponents_ImageSliderZoom = dynamic(() =>
  import("components/PageComponents/ImageSliderZoom")
);
...
Components.set("PageComponents_ImageLeftDarkRead", PageComponents_ImageLeftDarkRead);
Components.set("PageComponents_Cta4", PageComponents_Cta4);
Components.set("PageComponents_ImageLeftBlackRead", PageComponents_ImageLeftBlackRead);
Components.set("PageComponents_Column3", PageComponents_Column3);
Components.set("PageComponents_ImageRightBlackRead", PageComponents_ImageRightBlackRead);
Components.set("PageComponents_ImageLeftDarkWithOne", PageComponents_ImageLeftDarkWithOne);
Components.set("PageComponents_OnlyImageGallery", PageComponents_OnlyImageGallery);
