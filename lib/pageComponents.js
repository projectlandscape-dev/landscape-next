...
const PageComponents_RoundSection = dynamic(() =>
  import("components/PageComponents/RoundSection/RoundSection")
);
const PageComponents_RoundCorner2 = dynamic(() =>
  import("components/PageComponents/RoundCornor2/RoundCorner2")
);
const PageComponents_FourOrderImage = dynamic(() =>
  import("components/PageComponents/FourOrderImage/FourOrderImage")
);
const PageComponents_SliderWithContent = dynamic(() =>
  import("components/PageComponents/SliderWithContent/SliderWithContent")
);
const PageComponents_CustomPagingImage = dynamic(() =>
  import("components/PageComponents/CustomPagingImage/CustomPagingImage")
);
const PageComponents_DropdownMenus = dynamic(() =>
  import("components/PageComponents/DropdownMenus/DropdownMenus")
);
...
Components.set(
  "PageComponents_ImageSliderZoom",
  PageComponents_ImageSliderZoom
);
Components.set(
  "PageComponents_TwoImageWithColor",
  PageComponents_TwoImageWithColor
);
Components.set("PageComponents_RoundSection", PageComponents_RoundSection);
Components.set("PageComponents_RoundCorner2", PageComponents_RoundCorner2);
Components.set("PageComponents_FourOrderImage", PageComponents_FourOrderImage);
Components.set(
  "PageComponents_SliderWithContent",
  PageComponents_SliderWithContent
);
Components.set(
  "PageComponents_CustomPagingImage",
  PageComponents_CustomPagingImage
);
Components.set("PageComponents_DropdownMenus", PageComponents_DropdownMenus);
